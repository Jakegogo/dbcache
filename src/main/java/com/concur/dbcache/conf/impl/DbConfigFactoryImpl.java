...
import com.concur.dbcache.*;
import com.concur.dbcache.anno.Index;
import com.concur.dbcache.index.DbIndexService;
import com.concur.dbcache.support.asm.*;
import com.concur.dbcache.cache.CacheUnit;
import com.concur.dbcache.conf.CacheType;
import com.concur.dbcache.conf.DbConfigFactory;
		...
		ReflectionUtils.doWithFields(clz, new FieldCallback() {
			...
			public void doWith(Field field) throws IllegalArgumentException, IllegalAccessException {
				...
				if (field.isAnnotationPresent(Index.class)) {
					...
					Index indexAno1 = field.getAnnotation(Index.class);
					if (indexAno1 != null) {

...
import com.concur.unity.collections.concurrent.ConcurrentLRUCache;
import com.concur.unity.collections.concurrent.ConcurrentReferenceHashMap;
import org.springframework.stereotype.Component;

import java.lang.ref.ReferenceQueue;

/**
 * Apache solr ConcurrentLRUCache缓存容器
...
public class ConcurrentLruHashMapCache implements CacheUnit {
	...
	public void init(String name, int entityCacheSize, int concurrencyLevel) {
		...
		this.name = name;
		this.evictions = new ConcurrentReferenceHashMap<Object, Object>(ConcurrentReferenceHashMap.ReferenceType.STRONG, ConcurrentReferenceHashMap.ReferenceType.WEAK);
